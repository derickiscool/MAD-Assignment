...
public class foodFeed extends AppCompatActivity implements postAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(foodFeed.this);
    ...
    public void onItemClickListener(int position) {
        ...
        if (myUsername.equals(selectedItem.getUsername())) { // post belongs to user
            AlertDialog.Builder alert = new AlertDialog.Builder(foodFeed.this);
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() { // able to delete picture from firebase storage
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(foodFeed.this, "Item deleted", Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            Toast.makeText(foodFeed.this, "You are not allowed to delete this post!", Toast.LENGTH_LONG).show();
        }
    }
    @Override
